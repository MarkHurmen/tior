jQuery.handleError=function(s,xhr,status,e){if(s.error){s.error.call(s.context||s,xhr,status,e);}
...
data=r.responseText;var start=data.indexOf(">");if(start!=-1){var end=data.indexOf("<",start+1);if(end!=-1){data=data.substring(start+1,end);}}
